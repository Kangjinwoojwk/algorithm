def rotate(a):
    ...
    direction = a[1]
    if direction == '+':
        cube[location][0][2], cube[location][2][2], cube[location][2][0], cube[location][0][0] = \
        cube[location][0][0], cube[location][0][2], cube[location][2][2], cube[location][2][0]
        cube[location][1][2], cube[location][2][1], cube[location][1][0], cube[location][0][1] = \
        cube[location][0][1], cube[location][1][2], cube[location][2][1], cube[location][1][0]
    else:
        cube[location][0][0], cube[location][0][2], cube[location][2][2], cube[location][2][0] = \
        cube[location][0][2], cube[location][2][2], cube[location][2][0], cube[location][0][0]
        cube[location][0][1], cube[location][1][2], cube[location][2][1], cube[location][1][0] = \
    ...
    if a == 'U+':
        ...
        cube['B'][2][2], cube['B'][1][2], cube['B'][0][2], cube['U'][0][0], cube['U'][1][0], cube['U'][2][0] = \
        ...
        cube['B'][2][0], cube['B'][1][0], cube['B'][0][0], cube['U'][0][2], cube['U'][1][2], cube['U'][2][2]
    elif a == 'R-':
        cube['F'][0][2], cube['F'][1][2], cube['F'][2][2], cube['D'][0][2], cube['D'][1][2], cube['D'][2][2], \
        cube['B'][2][0], cube['B'][1][0], cube['B'][0][0], cube['U'][0][2], cube['U'][1][2], cube['U'][2][2] = \
        cube['U'][0][2], cube['U'][1][2], cube['U'][2][2], cube['F'][0][2], cube['F'][1][2], cube['F'][2][2], \
